    ...
    <div class="overflow-hidden">
      ...
      <div class="flex justify-end mb-10 mt-6 pl-7">
        ...
        <div id="print" class="w-full h-full text-center bg-gray-50 py-1 px-4"
          ...
          <div class="w-full h-full text-center" style="width: 100%; height: 100%; text-align: center; direction: rtl">
            <div class="text-center" style="text-align: center">
              <div class="text-2xl text-center font-semibold"
                style="font-size: 24px; line-height: 32px; text-align: center; font-weight: 900; padding-top: 44px; padding-bottom: 4px; padding-left: 12px; padding-right: 12px;">
                هيئة الرقابة الإدارية
                <div class="my-4" style="margin-top: 16px; margin-bottom: 16px">
                  تقرير بصادر {{ this.current_department_name }} {{ this.mailtype2 }}
                </div>

                <div class="ml-4 mt-4" style="margin-left: 16px; margin-top: 16px">
                ...
                <div v-for="(mail, index) in mails" :key="index" style="margin-top:48px">
                  ...
                  <table style="width: 100%; border:1px solid black; margin-top: 8px; font-size: 24px; width: 100%;">
                    ...
                    <tr v-for="sub_mail in mail.data" :key="sub_mail.mail_Number"
                      style="width: 100%; border:1px solid black;font-weight: 600; font-size: 1rem/* 24px */;line-height: 1.5rem/* 32px */;">
                      <td
                        style="border:1px solid black; width: 10%; text-align: center; padding-top:6px; padding-bottom: 6px;">
                        {{ sub_mail.mail_Number }}
                      </td>
                      <td
                        style="border:1px solid black; width: 40%; text-align: center; padding-top:6px; padding-bottom: 6px;">
                        {{ sub_mail.mail_Summary }}
                      </td>

                      <td
                        style="border:1px solid black; width: 20%; text-align: center; padding-top:6px; padding-bottom: 6px;">
...
export default {
  ...
  mounted() {
    ...
    if (localStorage.getItem("AY_LW") == null || localStorage.getItem("member") == "true" || (!this.roles.includes('aaa') || !this.roles.includes('mmm'))) {
      this.$router.push("/");
    }
    ...
    if (localStorage.getItem("isperent") === "true") {

      this.current_department_name =
        sessionStorage.getItem("dep_name")

    } else {


      this.current_department_name =
        localStorage.getItem("current_department_name")
    }

    console.log(localStorage.getItem("isperent"))
