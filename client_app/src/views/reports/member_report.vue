            ...
            >
              ...
              >
                <span class="ml-2" style="margin-left: 8px">
                  تقرير بالرسائل الواردة إلى  العضو {{ user_name}}  للفترة من
                </span>
              ...
              <!-- class="text-center border-black border-l-2 p-1"
                ...
                <div
                  ...
                  "
                >
                  <span class=""> {{ mail.sectionName }}</span>
                </div>
...
export default {
  ...
  mounted() {
    ...
    if (localStorage.getItem("AY_LW") == null || localStorage.getItem("member") != "true") {
      this.$router.push("/");
    }
...
localStorage.getItem("current_department_name")
  ...
  methods: {
   ...
   async printHistory() {
    ...
    back() {
      this.$router.push("/members_inbox");
    },
  },
};
</script>
