            ...
            >
              ...
              >
                <span class="ml-2" style="margin-left: 8px">
                  تقرير بالرسائل الواردة إلى العضو
                  {{ this.$route.params.member_name }} للفترة من
                </span>
              ...
              >
                ...
                <div
                  class="text-center p-1 border-l-2"
                  style="
                    width: 30%;
                    text-align: center;
                    padding: 4px;
                ...
                <div
                  ...
                  style="width: 11%; text-align: center; padding: 4px"
                >
                  الإنجاز
                </div>
              </div>
              ...
              <div
                ...
                :key="index"
                class="w-full flex border-r-2 border-l-2 border-black border-t"
                style="
                  width: 100%;
                  display: flex;
              ...
              >
                ...
                <div v-if="mail.memberMailIsDone"
...
export default {
  ...
  mounted() {
    ...
    if (localStorage.getItem("isperent") === "true") {
      this.current_department_name = sessionStorage.getItem("dep_name");
    } else {
      this.current_department_name = localStorage.getItem(
  ...
  methods: {
    get_date(d) {
      ...
      return date3.getFullYear() + "-" + month3 + "-" + day3;
    },
    printpage() {
