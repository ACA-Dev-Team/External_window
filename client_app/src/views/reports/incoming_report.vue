              ...
              >
                <span class="ml-2" style="margin-left: 8px">
                  تقرير بالرسائل الواردة إلى  {{ this.current_department_name}}  للفترة من
                      ...
                      <!-- <span class="ml-2" style="margin-left: 8px">
                  تقرير برسائل الصادر الخارجي للفترة من
                </span> -->
...
export default {
  ...
  mounted() {
    ...
    if (localStorage.getItem("AY_LW") == null || localStorage.getItem("member") == "true" || (!this.roles.includes('nnn') || !this.roles.includes('mmm'))) {
      this.$router.push("/");
    }
