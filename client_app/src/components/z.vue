<template>
  <div v-if="isOpen" class=" md:flex md:flex-shrink-0 bg-gray-50" >
          ...
          <nav class="flex-1 bg-gray-50 flex flex-col justify-between">
            <div class="px-2 space-y-1">
              ...
              <router-link data-tour="هذا الزر يتيح لك الانتقال الى صفحة البريد الوارد الخاص بك" v-if="roles.includes('nnn')&&ismember!='true'" title="البريد الوارد" :to="{ name: 'inbox' }"
                ...
                <span v-if="toggle_nav">
                  البريد الوارد
                      ...
                      <router-link v-if="ismember=='true'" title="البريد المخصص للعضو" :to="{ name: 'members_inbox' }"
                  ...
                  <g transform="translate(128 128) scale(0.72 0.72)" style="">
                    <g style="stroke: none; stroke-width: 0; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill-rule: nonzero; opacity: 1;"
                      ...
                      <path
                        ...
                        style="" transform=" matrix(1 0 0 1 0 0) " stroke-linecap="round" />
                    </g>
                  </g>
                </svg>
                <span v-if="toggle_nav">
              ...
              <router-link data-tour="صفحة دليل الالوان توضح لك رمزية كل لون مرتبط بالبريد" v-if="ismember!='true'" title=" دليل الالوان " :to="{ name: 'guidecolor' }" class="
                  ...
                  font-medium
                ">
                <svg class="text-gray-400 group-hover:text-gray-500 h-6 w-6" fill="none" stroke="currentColor"
                  viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 5.25a3 3 0 0 1 3 3m3 0a6 6 0 0 1-7.029 5.912c-.563-.097-1.159.026-1.563.43L10.5 17.25H8.25v2.25H6v2.25H2.25v-2.818c0-.597.237-1.17.659-1.591l6.499-6.499c.404-.404.527-1 .43-1.563A6 6 0 1 1 21.75 8.25Z" />
                ...
                <span v-if="toggle_nav">تغيير كلمة السر</span>
              </router-link>
...
export default {
  ...
  mounted() {
    ...
    this.ismember=localStorage.getItem("member") 
